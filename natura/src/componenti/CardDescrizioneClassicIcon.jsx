            ...
            <div className="card-body ">
                ...
                <div className="row">
                    ...
                    <div className="col-11 text-start">
                        <b >
                            <div className="row text-success ms-1">
                                Luogo
                            </div>
                            <div className="row ms-1">
                                {props.oggettoDettagio.provincia}-{props.oggettoDettagio.regione}
                            </div>
                        </b>
                    </div>
                </div>
                ...
                <div className="row mt-1">
                    ...
                    <div className="col-11 text-start">
                        <b>
                            ...
                            <div className="row ms-1">
                                {props.oggettoDettagio.enteGestore.nome}
                            </div>
                        </b>
                    </div>
                </div>
